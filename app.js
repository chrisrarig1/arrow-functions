...
//     It is the object Student {name: 'Joe', age: 'Schmoe', hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
//    Window {window: Window, self: Window, document: document, name: '', location: Location, …}
// 3. Explain why "this" is different when an arrow function is used.
//    Because arrow functions do not have prototypes. The this statment captures the surronding scope
//      instead of the scope of the object.